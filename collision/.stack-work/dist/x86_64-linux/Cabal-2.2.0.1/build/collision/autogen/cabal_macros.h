...
/* package collision-0.1.0.0 */
#ifndef VERSION_collision
#define VERSION_collision "0.1.0.0"
#endif /* VERSION_collision */
#ifndef MIN_VERSION_collision
#define MIN_VERSION_collision(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_collision */
...
#define CURRENT_COMPONENT_ID "collision-0.1.0.0-DBYroBhbH2TFP5fdozLYlA-collision"
